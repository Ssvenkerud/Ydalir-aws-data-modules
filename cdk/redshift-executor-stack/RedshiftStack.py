...
class RedshiftStack(Stack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # cluster password
        demo_cluster_secret = _sm.Secret(
            self,
        ...
        demo_cluster = _redshift.CfnCluster(
            ...
            vpc_security_group_ids=[dbt_to_redshift_sg.security_group_id],
        )
        ...
        output_2 = CfnOutput(
            ...
            value=(
                ...
                f"eu-north-1"
                f"#/secret?name="
                f"{demo_cluster_secret.secret_arn}"
            ),
